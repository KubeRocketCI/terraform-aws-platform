...
# Uncomment the following lines if you want to create access entry and policy association for CD Pipeline Agent
#
...
# CD Pipeline Operator Agent IAM Role in Account B
# Uncomment the following lines if you want to create CD Pipeline Operator Agent IAM Role in Account B
#
...
# Access Entry and Policy Association for ArgoCDAgent IAM Role in Account B
# Uncomment the following lines if you want to create access entry and policy association for ArgoCD Agent
#
...
# Argo CD Agent IAM Role in Account B
# Uncomment the following lines if you want to create ArgoCD Agent IAM Role in Account B
#
