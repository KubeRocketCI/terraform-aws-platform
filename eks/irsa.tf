...
# Access Entry and Policy Association for CDPipelineAgent IAM Role in Account B
# Uncomment the following lines if you want to create access entry and policy association for CDPipelineAgent IAM Role
...
# CDPipelineAgent IAM Role in Account B
# Uncomment the following lines if you want to create CDPipelineAgent IAM Role in Account B
# ref: https://docs.kuberocketci.io/docs/operator-guide/cd/deploy-application-in-remote-cluster-via-irsa
#
...
# Access Entry and Policy Association for ArgoCDAgentAccess IAM Role in Account B
# Uncomment the following lines if you want to create access entry and policy association for ArgoCDAgentAccess IAM Role
# ref: https://docs.kuberocketci.io/docs/operator-guide/cd/deploy-application-in-remote-cluster-via-irsa
#
...
# ArgoCDAgentAccess IAM Role in Account B
# Uncomment the following lines if you want to create ArgoCDAgentAccess IAM Role in Account B
# ref: https://docs.kuberocketci.io/docs/operator-guide/cd/deploy-application-in-remote-cluster-via-irsa
#
