...
create_iam_kaniko         = false                                                # Create IAM role for Kaniko
kaniko_ecr_repository_arn = "arn:aws:ecr:<REGION>:<AWS_ACCOUNT_ID>:repository/*" # ARN of the ECR repository used by Kaniko
