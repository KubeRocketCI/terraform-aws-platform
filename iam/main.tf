module "deployer_iam_role" {
  ...
  iam_permissions_boundary_policy_arn = var.deployer_iam_permissions_boundary_policy_arn
  tags                                = var.tags
}
...
module "kaniko_iam_role" {
  ...
  iam_permissions_boundary_policy_arn = var.kaniko_iam_permissions_boundary_policy_arn
